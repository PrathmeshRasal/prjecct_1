...
use App\Http\Controllers\Project\BusinessController;
...
Route::prefix('public')->group(function () {
    ...
    Route::post('/business-registration', [BusinessController::class, 'apiBusinessRegistration'])->name('api-public-post-business-registration');
...
Route::prefix('account')->group(function () {
    ...
    Route::post('business-login', [UserAccountController::class, 'apiPostBusinessLogin'])->name('api-admin-post-business-login');
